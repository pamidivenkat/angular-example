...
@Component({
  selector: 'yearendprocedure-ready',
  templateUrl: './yearendprocedure-ready.component.html',
  styleUrls: ['./yearendprocedure-ready.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None
})
export class YearendprocedureReadyComponent extends BaseComponent implements OnInit, OnDestroy {
