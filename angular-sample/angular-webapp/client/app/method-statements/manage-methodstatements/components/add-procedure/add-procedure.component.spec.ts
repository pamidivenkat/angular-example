...
describe('Method Statements add procedure Component', () => {
  ...
  describe('Component launch', () => {
    ...
    it('Add Procedure slideout-panel must be loaded without any errors', () => {
      expect(component).toBeTruthy();
    });
  });

  describe('Add Procedure form', () => {
    beforeEach(() => {
      fixture.detectChanges();
    });

    it('Verify whether Add Procedure slideout-panel title is "Add new procedure" or not.', () => {
      let titleElement = <HTMLElement>fixture.debugElement.query(By.css('#addprocedure_AeForm_1'))
        .query(By.css('.so-panel__title'))
        .query(By.css('h3')).nativeElement;
      expect(titleElement.innerText.trim()).toBe('MANAGE_METHOD_STM.SEQUENCE_OF_EVENTS.ADD_NEW_PROCEDURE');
    });

    it('Verify whether Add Procedure slideout-panel has agreed field names or not.', () => {
      let nameElement = <HTMLElement>fixture.debugElement.query(By.css('#addprocedure_AeForm_1'))
        .query(By.css('.so-panel__content'))
        .queryAll(By.css('.information-grid__item--input'))[0]
        .query(By.css('#addprocedure_AeForm_1_label_0'))
        .nativeElement;
      let nameText = nameElement.innerText.trim();
      expect(nameText).toBe('Name *');

      let descriptionElement = <HTMLElement>fixture.debugElement.query(By.css('#addprocedure_AeForm_1'))
        .query(By.css('.so-panel__content'))
        .queryAll(By.css('.information-grid__item--input'))[1]
        .query(By.css('#addprocedure_AeForm_1_label_1'))
        .nativeElement;
      let descText = descriptionElement.innerText.trim();
      expect(descText).toBe('Description');
    });

    it('Verify whether Add Procedure slideout-panel has agreed field types.', () => {
      let nameElement = <HTMLElement>fixture.debugElement.query(By.css('#addprocedure_AeForm_1'))
        .query(By.css('.so-panel__content'))
        .queryAll(By.css('.information-grid__item--input'))[0]
        .query(By.css('#addprocedure_AeForm_1_AeInput_0'))
        .nativeElement;
      ...
      let descriptionElement = <HTMLElement>fixture.debugElement.query(By.css('#addprocedure_AeForm_1'))
        .query(By.css('.so-panel__content'))
        .queryAll(By.css('.information-grid__item--input'))[1]
        .query(By.css('#addprocedure_AeForm_1_AeRichTextEditor_1'))
        .nativeElement;
      typeOfControl = descriptionElement instanceof HTMLTextAreaElement;
      expect(typeOfControl).toBeTruthy();
    });

    it('Verify whether "Add" button is appearning in UI or not', () => {
      let addBtn = <HTMLElement>fixture.debugElement.query(By.css('#addprocedure_AeForm_1'))
        .query(By.css('.so-panel__footer'))
        .queryAll(By.css('li'))[1]
        .query(By.css('a#addprocedure_AeForm_1_AeAnchor_1')).nativeElement;
    ...
    it('Verify whether user is able to click on "Add" button or not', () => {
      ...
      personName.setValue('AUT test procedure');
      let descControl = form.formGroup.controls.Description;
      descControl.setValue('<h1>AUT test procedure</h1>');
    ...
    it('Verify whether "Close" button is appearning in UI or not', () => {
      let closeBtn = <HTMLElement>fixture.debugElement.query(By.css('#addprocedure_AeForm_1'))
        .query(By.css('.so-panel__footer'))
  ...
  describe('Add Procedure slide-out panel save', () => {
