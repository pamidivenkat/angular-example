...
export class DocumentAddForm implements IFormBuilderVM {
    ...
    getFields(): Immutable.List<IFormFieldWrapper<any>> {
        ...
        this.filedArray.push(createFormFieldWrapperObject("Sensitivity", "", createFormFieldObject("Sensitivity", FormFieldType.InputString, "", [])));
        this.filedArray.push(createFormFieldWrapperObject("DocumentSite", "", createFormFieldObject("DocumentSite", FormFieldType.InputString, "", [])));
        this.filedArray.push(createFormFieldWrapperObject("Employee", "", createFormFieldObject("Employee", FormFieldType.InputString, "", [])));
